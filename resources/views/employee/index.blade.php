    ...
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form text-left" method="post" action="{{ route('employee.store') }}"
...
<!-- Edit Modal -->
<div id="editmodal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="warning-header-modalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            <div id="modals" class="modal-header modal-colored-header ">
            ...
            <div class="modal-body">
                <form id="editform" role="form text-left" method="post"
                    ...
                    <table id="multi_col_order" class="table table-striped table-bordered display no-wrap"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a id="edit" class="btn btn-circle btn-lg btn-warning edit" data-target="#myModal"
                                        data-id="{{$e->id}}" type="button" href="#">
...
{{-- <script>
  ...
  $(document).ready(function(){
    $('.btn btn-circle btn-lg btn-warning edit').click(function(){
